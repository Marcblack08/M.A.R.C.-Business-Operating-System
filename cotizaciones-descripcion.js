  ...
  function installUI(){
    ...
    if(!modal.querySelector('#qv3description')){
      ...
      if(quick){
        ...
        ta.oninput=()=>{window.__MARC_QUOTE_DESCRIPTION=ta.value};
