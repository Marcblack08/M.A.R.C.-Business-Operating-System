...
async async function serviceOrderReport(order){
 const close=modal('<div class="modal-head"><div><div class="eyebrow2">DOCUMENTO DE SERVICIO</div><h2>Informe / acta</h2><p>Genera un documento con la información registrada en la orden.</p></div><button class="close" id="sorClose">×</button></div><div id="sorBody">Preparando documento…</div>');
